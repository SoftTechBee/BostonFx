...
<head  runat="server">
    ...
    <title>Successfully Registration - Page |Boston FX</title>

    <meta name="description" content="Achieve new heights of SUCCESS in life Start your own BUSINESS" />
    <meta name="keywords" content="Bostonfx, businessBoston FX, login. ">
    <!-- Canonical SEO -->
...
<body id="top" data-theme-color="color-yellow"  style="background-image:url(bg.gif); background-size:cover; background-position:center">
 ...
 <!-- Content -->
                ...
                <div class="card">
                   <div class="card-body" style=" -webkit-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); -moz-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); box-shadow: 0px 0px 10px 5px #000000;">
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                            ...
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-info d-grid w-100" OnClick="btnLogin_Click"   Text="Login Now!" />
    ...
    <!-- / Content -->
<%-- <div class="buy-now">
        <a href="index.html" target="_blank" class="btn btn-danger btn-buy-now">Back ToBoston FX</a>
    </div>--%>
