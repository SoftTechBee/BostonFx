                    ...
                    <div class="card">
                        <div class="card-header with-border">
                            <div class="card-title">
                                <h3 class="text text-bold text-dark">Principle Investment Withdraw </h3>
                            </div>
                        </div>
                        <div class="card-body">
            ...
            <td><%#DataBinder.Eval(Container.DataItem, "DOR", "{0:dd/MM/yyyy}")%></td>
               ...
               <td > <asp:Label runat="server" ID="Days" Text='<%#Eval("nodays") %>'></asp:Label> Days</td>
                                ...
                                <div class=" row">
                                    ...
                                    <label class="control-label text-danger  col-lg-12">1)Any Time Withdrawal.</label>
                                    <label class="control-label text-danger  col-lg-12">2)If you make a withdraw before time period then deduction of 20% your principal amount</label>
