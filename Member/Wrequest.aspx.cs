            ...
            widamount = Convert.ToDecimal(txtAmt.Text.Trim());
                ...
                if (paymenttype.SelectedValue != "0")
                {
                    if (lbWallet.Text != "") //&& txtotp.Text != "")
                    {
                        ...
                        //{
                        if (finalamount >= widamount && widamount >= 1 && widamount<=500)
                        {
                        ...
                        else
                        {
                            ...
                            lbwarning.Text = "Insufficient USDT (or) Minimum Withdrawal 1$ Maximum 500$ and one day one Withdrawal";
    ...
    protected void txtAmt_TextChanged(object sender, EventArgs e)
    {
        try
        {
            //if (drpIncomeType.SelectedValue != "0")
            {
                ...
                {
                    if (reqAmt >= 20 && reqAmt <= 500)
                    {
                        //if (reqAmt % 10 == 0)
                        //{
                        decimal AdminCharge = Convert.ToDecimal(((double)reqAmt) * 5 / 100);
                        ...
                        //    sccess.Visible = false;
                        //    info.Visible = false;
                        //    lbwarning.Text = "USDT should be in multiple of 10$";
                        //    warning.Visible = true;
                        //    txtAmt.Text = "";
                        //    txtAmt.Focus();
                    ...
                    else
                    {
                        ...
                        sccess.Visible = false;
                        info.Visible = false;
                        lbwarning.Text = "USDT should be greater than or equal $20 & Less than $500";
                        warning.Visible = true;
                        txtAmt.Text = "";
                        txtAmt.Focus();
