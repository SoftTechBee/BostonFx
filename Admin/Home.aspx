                    ...
                    <div class="col-md-3 mt-3">
                        <div class="card coin-card">
							...
							<div class="col-md-3 mt-3">
								<div class="card coin-card">
									<div class="card-body ">
										<h4 class="card-title" style="font-size:18px;"><b>Direct Bonus</b></h4>
										<div class="d-flex align-items-center">
							...
							<div class="col-md-3 mt-3">
								<div class="card coin-card">
									<div class="card-body ">
										<h4 class="card-title" style="font-size:18px;"><b>Network Bonus</b></h4>
										<div class="d-flex align-items-center">
											
											<h2 class="fs-38"><asp:Label ID="lbnetworkincome" runat="server" Text="0"></asp:Label></h2>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-3 mt-3">
								<div class="card coin-card">
									<div class="card-body ">
										<h4 class="card-title" style="font-size:18px;"><b>Reward Bonus</b></h4>
										<div class="d-flex align-items-center">
							...
							<div class="col-md-3 mt-3">
								<div class="card coin-card">
									<div class="card-body ">
										<h4 class="card-title" style="font-size:18px;"><b>Royalty Bonus</b></h4>
										<div class="d-flex align-items-center">
							...
							<div class="col-md-3 mt-3">
								<div class="card coin-card">
									<div class="card-body ">
										<h4 class="card-title" style="font-size:18px;"><b>Level  Bonus</b></h4>
										<div class="d-flex align-items-center">
							...
							<div class="col-md-3 mt-3">
								<div class="card coin-card">
									<div class="card-body ">
										<h4 class="card-title" style="font-size:18px;"><b>Club  Bonus</b></h4>
										<div class="d-flex align-items-center">
											
											<h2 class="fs-38"> <asp:Label ID="lbclubincome" runat="server" Text="0"></asp:Label></h2>
										</div>
									</div>
								</div>
							</div>
